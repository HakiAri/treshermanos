            ...
            <div class="modal-body">
                <form role="form" id="frmEditar" name="frmEditar">
                    <div class="form-group">
                        ...
                        <input class=" form-control" id="name" name="name" minlength="3 " type="text" required autofocus="true" />
                    </div><br>
                    <div class="form-group">
                        <label for="user" class="control-label">Descripcion (Obligatorio)</label>
